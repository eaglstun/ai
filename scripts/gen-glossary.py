...
RELATED = {
    ...
    "gguf": ["mlx", "ggml", "parameters", "rss-sampler", "precision", "qwen"],
    "gpt": ["transformer", "gguf", "agi", "gelu", "qwen"],
    ...
    "transformer": ["attention", "gpt", "tensor", "lora", "gelu", "relu", "residual-connections", "norm-placement", "qwen"],
