...
SUMMARY = {
    ...
    "checkpoint": "A saved snapshot of a model's weights partway through training, so a run can be resumed, compared, or rolled back - and the best-scoring one is not automatically the best model.",
...
RELATED = {
    ...
    "checkpoint": ["parameters", "val-loss", "lora", "gradient-descent", "gguf"],
    ...
    "gguf": ["mlx", "ggml", "parameters", "rss-sampler", "precision", "quantization", "qwen", "temperature", "open-weights", "checkpoint"],
    "gpt": ["transformer", "gguf", "agi", "gelu", "qwen", "temperature", "token", "hallucination"],
    "gradient-descent": ["machine-learning", "parameters", "val-loss", "latent-space", "norm-placement", "epsilon-gate", "checkpoint"],
    "latent-space": ["gan", "dimensions", "embeddings", "gradient-descent"],
    "llamacpp-vs-ollama": ["gguf", "ggml", "metal", "cuda", "vulkan", "temperature"],
    "lora": ["transformer", "tensor", "gguf", "parameters", "qwen", "quantization", "open-weights", "checkpoint"],
    ...
    "parameters": ["tensor", "transformer", "gguf", "lora", "val-loss", "gradient-descent", "rss-sampler", "precision", "quantization", "model-welfare", "mixture-of-experts", "open-weights", "checkpoint"],
    ...
    "val-loss": ["machine-learning", "parameters", "gradient-descent", "epsilon-gate", "checkpoint"],
