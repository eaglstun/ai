...
# 1. list your replies (id, text, permalink)
curl -s "https://graph.threads.net/v1.0/${THREADS_USER_ID}/replies?fields=id,text,permalink,timestamp&limit=25&access_token=${THREADS_ACCESS_TOKEN}"
# 2. for each reply id, its engagement
