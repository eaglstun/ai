...
has to do an annoying dance: cuBLAS is column-major, so the existing GEMM code swaps and
...
The exact GELU activation - the smooth gate inside most modern transformers - is defined in
