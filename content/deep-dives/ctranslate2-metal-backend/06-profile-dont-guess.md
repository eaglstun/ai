...
single elementwise **`Add`** - the residual connection - and in 16-bit it had exploded **27×**.
...
the mid-size shapes that match actual LLM hidden dimensions - and crucially it helps _without_
