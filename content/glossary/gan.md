...
+++
**GAN** (Generative Adversarial Network) is a generative model architecture, introduced by
Ian Goodfellow and colleagues in 2014, built from two neural networks locked in competition.
The **generator** takes a random latent vector and tries to produce realistic fake samples
