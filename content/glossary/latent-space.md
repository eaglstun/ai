...
diffusion models, and embedding models all rely on it; generative models work by sampling
or steering points in latent space and then decoding them back into images, text, or audio.
