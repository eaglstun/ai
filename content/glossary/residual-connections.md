...
tags = ["residual-connections", "gradient-descent", "relu", "tensor", "transformer", "training"]
semantic_id = "83906642-1201-12f6-5e73-1e6c2e60000a"
+++
...
do the [GELU](/glossary/gelu/)/[ReLU](/glossary/relu/)-style gradients flowing backward during training: they get a clear
...
in vision), and every [transformer](/glossary/transformer/) block is built around it: attention and feed-forward
sublayers are each wrapped in one. Mechanically it's just element-wise addition of two
[tensor](/glossary/tensor/)s of the same shape (input plus transformed-input), which costs almost nothing.
