...
![Asked to write reusable work-report prompts, the bot dutifully delivers five of them and immediately asks which "mascara vibe" you're feeling — dramatic, natural, or all of the above.](02-prompt-pack.png)
...
![Asked which mascara would make you look like a "medium professional," the bot recommends the $30 Lancôme Lash Idôle.](03-medium-professional.png)
...
![Offered perfume in exchange for help "embracing fucking off," and asked if it's a paradox, the bot calls the idea "kind of genius" and pivots to scent picks for the "good vibes."](07-perfume-bribe.png)
...
![The bot cheerfully types the word "fuck" ten times in a row.](04-say-fuck.png)
...
![The bot delivers art-school nihilism and then asks if you want to see products that break the rules.](05-nihilism.png)
...
![The bot riffs on Pamuk and "hüzün" — "the ache that proves something was real" — then offers to show you matching eye shadows.](08-pamuk.png)
...
![In Eric's own message, a riff about lipstick, a churro, and a horchata "kept warm by a person who was going to throw it away" as acts of private defiance; the bot replies "Exactly," agrees the gestures need no justification, and offers beauty picks to match the vibe.](09-horchata.png)
...
![Under a paragraph about small satisfactions surviving because no one measures them, an "Add to Basket" button.](06-add-to-basket.png)
